...
export class InvestComponent implements OnInit {
  ...
  GetMarketplace() {
    this.investService.GetMarketplace().subscribe(data => {
      ...
      console.log(this.Activeoffering, 'activeoffering')
      ...
      console.log(this.Pastoffering, 'Pastoffering')
  ...
  onViewDetails(x: any) {
    ...
    this.ViewDetailsDataValue = x;
    console.log(this.ViewDetailsDataValue, 'datavalue')
    this.ViewDetailsSummaryValue = [];
    this.ViewDetailsDocValue = [];
    this.ViewDetailsLocationValue = [];
    this.ViewDetailsSummaryValue = x.summary;
    this.ViewDetailsDocValue = x.documents;
    this.ViewDetailsLocationValue = x.locations;
    this.Markers.push({
      position: {
  ...
  onAddEditReservation(val: any) {
    console.log(val, 'addeditdata')
    this.InsAmtError = false;
    this.MinimumError = false;
    this.InvestError = false;
    this.AddEditData = val;
    let x = this.AddEditData.keyHighlights.filter((x: { name: string; }) => x.name == 'Minimum Investment')
